...
entry_points = {
    'console_scripts': [
        ...
        'ollbrowse=olltools.olebrowse:main',
        'olldir=olltools.oledir:main',
        'ollid=olltools.oleid:main',
        'ollmap=olltools.olemap:main',
        'ollmeta=olltools.olemeta:main',
        'olltimes=olltools.oletimes:main',
        'ollvba=olltools.olevba:main',
        'pyxswf=olltools.pyxswf:main',
        'rtfobj=olltools.rtfobj:main',
        'ollobj=olltools.oleobj:main',
        'ollfile=ollfile.olefile:main',
    ],
}
